  ...
  3. If you skipped steps 1 and 2 above (shame on you), then here is the absolute minimum
     ...
     * Site breakage WILL happen
         - There are often trade-offs and conflicts between Security vs Privacy vs Anti-Fingerprinting
           and these need to be balanced against Functionality & Covenience & Breakage
     * You will need to make a few changes to suit your own needs
         - Search this file for the "[WARNING]" tag to troubleshoot SOME common issues
         - Search this file for the "[SETUP]" tag to troubleshoot and also to find SOME common
           items you could check before using to avoid unexpected surpises
  4. BACKUP BACKUP BACKUP your profile folder before implementing
...
/* 0410b1: disable "Block dangerous downloads" This setting is under Options>Security
...
/* 0410b2: disable "Warn me about unwanted and uncommon software" Also under Options>Security (FF48+) ***/
 ...
 * There SHOULD be NO privacy concerns here, but you we think can do better with uBlock Origin which
 * offers more comprehensive as well as specialized lists. It also allows per domain control.
...
/* 2450b: change size of warning quota for offline cache (default 51200)
 ...
 * [WARNING] [SETUP] Affects text rendering (fonts will look different) and impacts video imperformance
 ...
 * [WARNING] this will break add-ons (eg Roboform) that do not use the default XPI directories
